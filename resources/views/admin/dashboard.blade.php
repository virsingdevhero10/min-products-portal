      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="col-xxl-3 col-xl-12">
            ...
            <div class="card-body">
                <h5 class="card-title">Users <span>| Total Users</span></h5>
            ...
            <div class="col-xxl-3 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Products <span>| Total Products</span></h5>
            ...
            <div class="col-xxl-3 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Categories <span>| Total Categories</span></h5>
              ...
              <div class="col-xxl-3 col-xl-12">
                ...
                <div class="card-body">
                    <h5 class="card-title">Sub Categories <span>| Total Sub Categories</span></h5>
